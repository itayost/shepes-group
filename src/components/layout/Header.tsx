        ...
        <div className="container">
          <div className="flex justify-between items-center h-20">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : 'text-gray-300 hover:bg-primary-500/10 hover:text-primary-500'
                    )}
                  >
                    {item.label}
                  </Link>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Link href="/contact">
                <Button 
                  ...
                  size="md"
                  icon={Mail}
                  className="bg-gradient-to-r from-primary-500 to-primary-600 text-black hover:from-primary-400 hover:to-primary-500 shadow-gold hover:shadow-gold-glow"
                >
                  קבעו פגישה
                </Button>
              </Link>
            ...
            <button
              ...
              className="lg:hidden relative p-2.5 rounded-lg text-primary-500 hover:bg-primary-500/10 transition-all duration-200"
              aria-label="תפריט"
            >
      ...
      >
        ...
        <div className="h-[calc(100%-80px)] overflow-y-auto">
          ...
          <div className="p-4 border-t border-primary-500/20">
            ...
            <a
              href={`tel:${SITE_CONFIG.phone}`}
              className="flex items-center justify-center gap-2 text-black bg-gradient-to-r from-primary-500 to-primary-600 py-3 px-4 rounded-xl font-medium hover:from-primary-400 hover:to-primary-500 transition-all shadow-gold mb-3"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <Phone className="w-5 h-5" />
              <span>{SITE_CONFIG.phone}</span>
            ...
            <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)}>
              <Button 
                ...
                fullWidth
                icon={Mail}
                className="border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-black"
              >
                השאירו פרטים
              </Button>
            </Link>
          ...
          <div className="p-4 border-t border-primary-500/20">
            <div className="text-center text-sm text-gray-400">
              <p className="font-medium mb-2 text-primary-500">שעות פעילות</p>
            ...
            <div className="flex justify-center gap-3">
              {SITE_CONFIG.social?.facebook && (
                <a
                  ...
                  className="w-10 h-10 bg-primary-500/10 hover:bg-primary-500/20 rounded-full flex items-center justify-center transition-all hover:scale-110 group border border-primary-500/30"
                  aria-label="Facebook"
                >
