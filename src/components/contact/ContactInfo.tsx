      ...
      >
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            <div className="group">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-text-muted mb-1">טלפון משרד</p>
                  <div className="flex items-center gap-2">
                    <a 
                      href={`tel:${SITE_CONFIG.phone}`}
                      className="text-text-gold-bright font-medium hover:text-text-gold transition-colors"
                    >
                      {SITE_CONFIG.phone}
                    </a>
                    <button
            ...
            <div className="group">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-success-500 to-success-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <MessageCircle className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1">
                  <p className="text-sm text-text-muted mb-1">וואטסאפ</p>
                  <a 
                    href={`https://wa.me/${SITE_CONFIG.whatsapp}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-success-500 font-medium hover:text-success-600 transition-colors"
                  >
                    שלח הודעה
                  </a>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <a 
                      ...
                      className="text-text-gold-bright font-medium hover:text-text-gold transition-colors break-all"
                    >
                      {SITE_CONFIG.email}
                    </a>
                    <button
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center pb-3 border-b border-primary-500/20">
              ...
              <span className="text-text-gold-bright font-medium">9:00 - 18:00</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-primary-500/20">
              <span className="text-text-secondary">שישי</span>
              <span className="text-text-gold-bright font-medium">9:00 - 13:00</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-text-secondary">שבת</span>
              <span className="text-text-muted">סגור</span>
            </div>
          </div>
      ...
      >
        <CardContent className="p-6">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold text-text-primary">עקבו אחרינו</h2>
          </div>
            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                <a
                  ...
                  title={social.label}
                  className={cn(
                    "w-12 h-12 bg-primary-500/10 rounded-lg flex items-center justify-center",
