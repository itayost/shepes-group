...
const faqData = [
  {
    ...
    answer: 'בממוצע, הנכסים שלנו נמכרים תוך 21 ימים בלבד הודות לשיווק המקצועי והממוקד שלנו. הזמן תלוי במיקום, מחיר ומצב הנכס.'
  },
  {
    question: 'מה מיוחד בשיווק שלכם?',
    answer: 'אנו מתמחים בשיווק מקצועי ומתקדם - שיווק דיגיטלי, צילום מקצועי, חשיפה מקסימלית ברשתות חברתיות ופורטלים, וליווי צמוד לאורך כל התהליך.'
  },
  {
  ...
  {
    question: 'אילו סוגי נכסים אתם משווקים?',
    answer: 'אנו משווקים כל סוג של נכס - נכסי יד שנייה, פרוייקטים חדשים, נכסים מסחריים, דירות, בתים פרטיים, פנטהאוזים ועוד.'
  },
  {
    question: 'באילו אזורים אתם פועלים?',
    answer: 'אנו מתמחים באזור חיפה. ההיכרות המעמיקה שלנו עם כל שכונה ורחוב בעיר מאפשרת לנו לספק שירות מקצועי ומדויק במיוחד.'
  }
];
